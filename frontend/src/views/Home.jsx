  ...
  return <div className="narrow">
    ...
    {!S.routines.length && !S.active && (
      <div className="card">
        ...
        <div className="muted small" style={{ marginBottom: 12 }}>{t('Choose a ready-made plan for 2, 3 or 4 training days — you can customize it anytime.')}</div>
        <Button variant="primary" icon="sparkles" onClick={starterPlanSheet}>{t('Choose a starter plan')}</Button>
