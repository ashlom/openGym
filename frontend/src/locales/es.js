...
export default {
  ...
  // --- Huawei AH100 / CH100 Bluetooth scale ---
  'Connect Huawei scale': 'Conectar balanza Huawei',
  'AH100 / CH100 via Bluetooth on Android': 'AH100 / CH100 por Bluetooth en Android',
  'Reading scale…': 'Leyendo balanza…',
  'Choose Huawei AH100 / CH100 in the Bluetooth list…': 'Elegí Huawei AH100 / CH100 en la lista de Bluetooth…',
  'Connecting to {0}…': 'Conectando con {0}…',
  'Checking the scale connection…': 'Comprobando la conexión de la balanza…',
  'Linking the scale to openGym…': 'Vinculando la balanza con openGym…',
  'Preparing your scale profile…': 'Preparando tu perfil en la balanza…',
  'Step on the scale barefoot and wait for the measurement…': 'Subite descalzo a la balanza y esperá la medición…',
  'This scale is linked to another app.': 'Esta balanza está vinculada con otra aplicación.',
  'The scale battery is low.': 'La balanza tiene poca batería.',
  'The scale went to sleep. Step on it and try again.': 'La balanza se apagó. Subite y volvé a intentar.',
  'Scale disconnected.': 'La balanza se desconectó.',
  'Connection cancelled.': 'Conexión cancelada.',
  'Weight received.': 'Peso recibido.',
  'Weight received: {0}': 'Peso recibido: {0}',
  'Could not read the scale. Try again.': 'No se pudo leer la balanza. Volvé a intentar.',
  'Bluetooth scales require Chrome on Android and a secure HTTPS connection.': 'Las balanzas Bluetooth requieren Chrome en Android y una conexión HTTPS segura.',
  'That Huawei scale model uses a different protocol.': 'Ese modelo de balanza Huawei usa otro protocolo.',
  'The scale disconnected before finishing.': 'La balanza se desconectó antes de terminar.',
  'The Bluetooth connection timed out. Wake the scale and try again.': 'La conexión Bluetooth agotó el tiempo. Activá la balanza y volvé a intentar.',
  'The scale did not answer the connection check.': 'La balanza no respondió a la comprobación de conexión.',
  'The scale did not finish linking to openGym.': 'La balanza no terminó de vincularse con openGym.',
  'No measurement arrived. Wake the scale and try again.': 'No llegó ninguna medición. Activá la balanza y volvé a intentar.',
  'The scale reported too much weight.': 'La balanza informó exceso de peso.',
  'Measurement failed. Stand barefoot on the metal contacts.': 'La medición falló. Parate descalzo sobre los contactos metálicos.',
  'The scale marked that measurement as unreliable. Please try again.': 'La balanza marcó la medición como poco confiable. Volvé a intentar.',
  'Could not connect. Check the Bluetooth address and try again.': 'No se pudo conectar. Revisá la dirección Bluetooth y volvé a intentar.',
  'Enter a valid Bluetooth address, age and height.': 'Ingresá una dirección Bluetooth, edad y altura válidas.',
  'Link scale to openGym?': '¿Vincular la balanza con openGym?',
  'This replaces the scale’s current app link. Huawei’s scale app may need to be linked again if you want to use it later.': 'Esto reemplaza la vinculación actual de la balanza. Si después querés usar la aplicación de Huawei, posiblemente tengas que vincularla de nuevo.',
  'Link to openGym': 'Vincular con openGym',
  'Huawei AH100 / CH100 setup': 'Configuración Huawei AH100 / CH100',
  'One-time setup. Find the Bluetooth address (MAC) in an app such as nRF Connect, then enter your real profile data for body composition. These scale settings stay only on this device.': 'Configuración inicial. Buscá la dirección Bluetooth (MAC) con una aplicación como nRF Connect e ingresá tus datos reales para calcular la composición corporal. Estos datos de la balanza quedan sólo en este dispositivo.',
  'Bluetooth address (MAC)': 'Dirección Bluetooth (MAC)',
  'Age': 'Edad',
  'Height (cm)': 'Altura (cm)',
  'Sex': 'Sexo',
  'Save and connect': 'Guardar y conectar',
  'Scale settings': 'Configurar balanza',
  'Forget this scale?': '¿Olvidar esta balanza?',
  'Removes the Bluetooth address, profile data and local scale key from this device. Connecting again will require setup and may require linking the scale again.': 'Elimina de este dispositivo la dirección Bluetooth, los datos de perfil y la clave local de la balanza. Para volver a conectar habrá que configurarla y posiblemente vincularla de nuevo.',
  'Forget scale': 'Olvidar balanza',
  'That reading belongs to another profile.': 'Esa medición pertenece a otro perfil.',
  'Bluetooth scale connection is available in Chrome on Android over HTTPS.': 'La conexión con balanzas Bluetooth está disponible en Chrome para Android mediante HTTPS.',
  ...
  'Choose a ready-made plan for 2, 3 or 4 training days — you can customize it anytime.': 'Elegí un plan preparado para entrenar 2, 3 o 4 días; después podés personalizarlo.',
  'Choose a starter plan': 'Elegir un plan inicial',
  'Choose by how many days you want to train. You can edit every routine later.': 'Elegí según cuántos días quieras entrenar. Después podés editar todas las rutinas.',
  'Loading a preset replaces your routines and assigned training days. Your workout history stays intact.': 'Al cargar un plan se reemplazan tus rutinas y los días asignados. Tu historial se conserva.',
  'Options for 2, 3 or 4 training days': 'Opciones para entrenar 2, 3 o 4 días',
  'Plan loaded: {0}': 'Plan cargado: {0}',
  'Replace current plan?': '¿Reemplazar el plan actual?',
  'This replaces your current routines and weekly schedule. Your completed workout history is kept.': 'Esto reemplaza tus rutinas y la planificación semanal actuales. El historial de entrenamientos completados se conserva.',
  'Replace plan': 'Reemplazar plan',
  '{0} days/week': '{0} días/semana',
  'Full Body · 2 days': 'Cuerpo completo · 2 días',
  'Full Body · 3 days': 'Cuerpo completo · 3 días',
  'Upper / Lower · 4 days': 'Torso / Pierna · 4 días',
  'Push / Pull / Legs · 3 days': 'Empuje / Tirón / Piernas · 3 días',
  'A simple whole-body start with plenty of recovery.': 'Un inicio simple de cuerpo completo con buena recuperación.',
  'Balanced beginner plan for Monday, Wednesday and Friday.': 'Plan equilibrado para principiantes: lunes, miércoles y viernes.',
  'More weekly volume split between upper and lower body.': 'Más volumen semanal dividido entre torso y piernas.',
  'One focused push, pull and leg session each week.': 'Una sesión semanal enfocada en empuje, tirón y piernas.',
  ...
  'Password': 'Contraseña',
  'Sign in': 'Ingresar',
  'Sign in with username and password': 'Ingresar con usuario y contraseña',
  'Signing in…': 'Ingresando…',
  'Enter username and password': 'Ingresá usuario y contraseña',
  'Invalid username or password': 'Usuario o contraseña incorrectos',
  'Too many attempts — try again later': 'Demasiados intentos — probá de nuevo más tarde',
  'or use a passkey': 'o usá una passkey',
  'Your account syncs securely across your devices.': 'Tu cuenta se sincroniza de forma segura entre tus dispositivos.',
  ...
  'Your gym data is synced and cleared from this device. A linked Bluetooth scale stays paired until you choose Forget scale.': 'Tus datos del gimnasio se sincronizan y se borran de este dispositivo. Una balanza Bluetooth vinculada sigue emparejada hasta que elijas Olvidar balanza.',
  'Sign out': 'Cerrar sesión',
